...
//     version 1.3.0
//     from Assets/Scripts/_Internal/Settings/MineBuddiesInputActions.inputactions
//
...
{
    public partial class @MineBuddiesInputActions : IInputActionCollection2, IDisposable
    {
        public InputActionAsset asset { get; }
        public @MineBuddiesInputActions()
        {
    ...
    ""controlSchemes"": [
        ...
        },
        {
            ...
            m_PlayerControls_RotationalMovement = m_PlayerControls.FindAction("RotationalMovement", throwIfNotFound: true);
            // PlayerJoin
            m_PlayerJoin = asset.FindActionMap("PlayerJoin", throwIfNotFound: true);
            m_PlayerJoin_Go = m_PlayerJoin.FindAction("Go", throwIfNotFound: true);
            m_PlayerJoin_Back = m_PlayerJoin.FindAction("Back", throwIfNotFound: true);
        }
        ...
        private readonly InputAction m_PlayerControls_RotationalMovement;
        public struct PlayerControlsActions
        {
            private @MineBuddiesInputActions m_Wrapper;
            public PlayerControlsActions(@MineBuddiesInputActions wrapper) { m_Wrapper = wrapper; }
            ...
            public InputAction @RotationalMovement => m_Wrapper.m_PlayerControls_RotationalMovement;
            ...
            public void SetCallbacks(IPlayerControlsActions instance)
            {
                if (m_Wrapper.m_PlayerControlsActionsCallbackInterface != null)
                {
                    ...
                    @RotationalMovement.started -= m_Wrapper.m_PlayerControlsActionsCallbackInterface.OnRotationalMovement;
                    @RotationalMovement.performed -= m_Wrapper.m_PlayerControlsActionsCallbackInterface.OnRotationalMovement;
                    @RotationalMovement.canceled -= m_Wrapper.m_PlayerControlsActionsCallbackInterface.OnRotationalMovement;
                }
                ...
                if (instance != null)
                {
                    ...
                    @RotationalMovement.started += instance.OnRotationalMovement;
                    @RotationalMovement.performed += instance.OnRotationalMovement;
                    @RotationalMovement.canceled += instance.OnRotationalMovement;
                }
            }
        }
        ...
        private IPlayerJoinActions m_PlayerJoinActionsCallbackInterface;
        private readonly InputAction m_PlayerJoin_Go;
        private readonly InputAction m_PlayerJoin_Back;
        public struct PlayerJoinActions
        {
            private @MineBuddiesInputActions m_Wrapper;
            public PlayerJoinActions(@MineBuddiesInputActions wrapper) { m_Wrapper = wrapper; }
            public InputAction @Go => m_Wrapper.m_PlayerJoin_Go;
            public InputAction @Back => m_Wrapper.m_PlayerJoin_Back;
            ...
            {
                if (m_Wrapper.m_PlayerJoinActionsCallbackInterface != null)
                {
                    @Go.started -= m_Wrapper.m_PlayerJoinActionsCallbackInterface.OnGo;
                    @Go.performed -= m_Wrapper.m_PlayerJoinActionsCallbackInterface.OnGo;
                    @Go.canceled -= m_Wrapper.m_PlayerJoinActionsCallbackInterface.OnGo;
                    @Back.started -= m_Wrapper.m_PlayerJoinActionsCallbackInterface.OnBack;
                    @Back.performed -= m_Wrapper.m_PlayerJoinActionsCallbackInterface.OnBack;
                    @Back.canceled -= m_Wrapper.m_PlayerJoinActionsCallbackInterface.OnBack;
                }
                m_Wrapper.m_PlayerJoinActionsCallbackInterface = instance;
                if (instance != null)
                {
        ...
        public interface IPlayerControlsActions
        {
            ...
            void OnRotationalMovement(InputAction.CallbackContext context);
        }
